...
impl Set{
    ...
    pub(crate) fn parse_frames(parse: &mut Parse) -> crate::Result<Set>{
        ...
        // Read tke value to set. This is a required field.
        ...
        match parse.next_string(){
            ...
            Ok(s) if s.to_uppercase() == "PX" => {
                // An expireation is specified in milliseconds . The next value is 
                // an integer.
            ...
            Ok(_) => return Err("currently `SET` only suports the expiration option".into()),
